defmodule Main do
  ...
  defp read_string_lines_sub(n, acc), do: read_string_lines(n-1, [read_string() | acc])
  ...
  defp read_multi_string_array_sub(n, acc), do: read_multi_string_array(n-1, [read_string_array() | acc])
